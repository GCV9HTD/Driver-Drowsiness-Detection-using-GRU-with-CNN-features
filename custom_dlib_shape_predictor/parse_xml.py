...
# dlib shape predictor on *just* the mouth, we must first define the
# integer indexes that belong to the eyes
o=[]
o.append(48)#left Corner of lip
o.append(51)#top of lip
o.append(54)#right corner of lip
o.append(57)#bottom of lip
